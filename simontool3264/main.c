...
#define _BUILD_MAIN
static const u32 prog_version=0x00010000;
...
fprintf(stdout,"simon3264 is limited only to a block of 32 bits and a key of 64 due to export control constraints.  For the complete source, please visit http://simon.ece.gatech.edu\n"); 
...
int main (int argc, char **argv) {
	...
	while ( (c = getopt(argc, argv, "ab:z:c:k:i:o:s:w:t:l:?hv:de")) != -1) {
        switch (c) {
